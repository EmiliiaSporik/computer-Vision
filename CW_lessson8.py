...
while True:
    ...
    # faces = face_cascade.detectMultiScale(gray, scaleFactor = 1.1, minNeighbors = 5, minSize = (30, 30)) #1 - кофіцієнт зменшення зображення (масштабування), 2 - кількість перевірок, 3 - мінімальний розмір області
    # for x, y, w, h in faces:
    #     cv2.rectangle(frame, (x, y), (x + w, y + h), (0, 255, 0), 2)
    # # print(faces)
    #     roi_gray = gray[y:y + h, x:x + w]
    #     roi_color = frame[y:y + h, x:x + w] #зріз частини зображення з обличчям
    ...
    #
    # cv2.putText(frame, f'Faces detected: {len(faces)}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
