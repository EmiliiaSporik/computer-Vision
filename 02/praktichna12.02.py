...
while True:
    ...
    # Трекінг (тільки транспорт: 2=car, 3=motorcycle, 5=bus, 7=truck)
    ...
    cv2.line(frame, LINE_END[0], LINE_END[1], (0, 0, 255), 2)  # Red
