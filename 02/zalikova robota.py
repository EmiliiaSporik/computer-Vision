...
# --- КОНФІГУРАЦІЯ ---
VIDEO_FILENAME = "video1.mp4"  # Назва вашого відео у папці video
VIDEO_PATH = os.path.join(VIDEO_DIR, VIDEO_FILENAME)
OUTPUT_VIDEO_PATH = os.path.join(OUT_DIR, f"result_{VIDEO_FILENAME}")

CONF_THRESHOLD = 0.3  # Поріг впевненості
RESIZE_WIDTH = 1280  # Ширина для зміни розміру (None, якщо не потрібно)

# ID класів COCO для транспорту:
...
# --- ПІДГОТОВКА ДО ЗАПИСУ ВІДЕО (БОНУС) ---
# Отримуємо параметри відео
fps_input = cap.get(cv2.CAP_PROP_FPS)
# Ширина та висота будуть визначені після першого кадру (через можливий resize)
video_writer = None
